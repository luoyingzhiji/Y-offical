  ...
  <div class="totalFrame ">
    ...
    <div class="trialFrame-contain clearFix">
      ...
      <div class="register-content">
        <p class="contact-title" v-if="!isRegister">免费注册</p>
        <ul class="logVam" style="width: 380px;">
          ...
          <li class="inputItem input_Item" v-if="this.info==true">
            <div class="chooseOption">
              <select id="queryType"  class="input-select" style="height: 49px;padding: 0;width: 360px"  >
          ...
          <li class="inputItem input_Item" v-if="this.info==true">
            <div class="chooseOption">
              <select id="queryProduct" class="input-select" style="padding: 0;width: 360px" >
          ...
          <li style="font-size: 14px;color: #666" class="clearFix">
            <div style="float: left" class="clearFix">
              ...
              <p style="float:right;">
                我已阅读并接受
                <a href="/help/234" target="_blank" style="color: #1890FF">《服务协议》</a>
              </p>
            </div>
            <p style="float:right;">
              已有帐号？
