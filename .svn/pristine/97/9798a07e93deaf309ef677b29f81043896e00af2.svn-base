<template>
  <div>
    ...
    <div class="article-rank" v-if="connetList.length!=0" style="margin-bottom: 30px;">
      <p>相关阅读</p>
    ...
    <div class="A_wrap-cont-right">
      <!--<Arti></Arti>-->
      <a class="link-desc" v-if="businessType==2" tag="div" href="/enterprise">
